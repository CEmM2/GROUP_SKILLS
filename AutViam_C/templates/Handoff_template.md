...
**Next command:** `AutViam_C scaffold <phase_id+1> <plan_file>` or `AutViam_C exec <phase_id+1> <plan_file>`
...
### Process
> Parallelism conflicts, Codex agent coordination issues, review loop patterns, etc.
