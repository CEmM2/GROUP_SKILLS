...
2. **Materialise**: save the captured body to `/tmp/issue_<N>_body.md` with a Codex file-editing tool.
...
4. **Push back** (1 shell call): `gh issue edit <issue_number> --body-file /tmp/issue_<N>_body.md`.
