...
**Output is transient** — `dev/diagrams/<slug>.html`, an understanding aid, not a planning asset. (For a durable, reusable module/feature snapshot, use `/AutViam arch` instead — it writes to `dev/architecture/` with a planning digest.)
